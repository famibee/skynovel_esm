...
import { n as y } from "./Config.js";
import { t as b } from "./Layer.js";
import { t as x } from "./PlgLayer.js";
import { i as S, r as C, t as w } from "./Reading.js";
import { t as T } from "./SpritesMng.js";
import { Button as E } from "./Button.js";
import { t as D } from "./RubySpliter.js";
import { TxtLayer as O, t as k } from "./TxtLayer.js";
import { GrpLayer as A, t as j } from "./GrpLayer.js";
...
var M = class e {
	...
	#o(n) {
		...
		t.#n.cvs.insertAdjacentHTML("beforebegin", `<iframe id="${i}" style="opacity: ${String(o)}; ${f} position: absolute; left:${String(t.#t.ofsLeft4elm + p.x * t.#t.cvsScale)}px; top: ${String(t.#t.ofsTop4elm + p.y * t.#t.cvsScale)}px; z-index: ${String(N)}; border: 0px; overflow: hidden; display: ${d ? "inline" : "none"}; transform: scale(${String(s)}, ${String(c)}) rotate(${String(l)}deg);" width="${String(p.width * t.#t.cvsScale)}" height="${String(p.height * t.#t.cvsScale)}"></iframe>`);
		let h = w.procID + `add_frame id:${i}`;
		w.beginProc(h);
	...
	#g(e) {
		...
		}), this.appPixi.stage.interactive = !1, C.tween(`frm\n${n}`, e, m, C.cnvTweenArg(e, m), (e) => {
			g(e), _(e), y(e), b(e);
		}, () => {
...
var L = class e {
	...
	constructor(e, t, n, r, i, a, o, c, l) {
		...
		o.cvsResize(), this.#a = new F(this.cfg.oCfg, t, r), O.init(e, t, r, this.#a, (e) => this.#x[e.layname].fore === e, n), A.init(i, e, n, o, c, r), x.setup(n, o, (e) => this.#x[e.layname]?.fore === e), P.init(e, o, i), this.#r = new P(t, n, r), t.loadplugin = (e) => this.#y(e), t.snapshot = (e) => this.#h(e), this.#g = this.sys.isApp ? (e, t, n, r, i) => this.#_(e, t, n, r, i) : (e, t, n, r, i) => this.#v(e, t, n, r, i), t.add_lay = (e) => this.#b(e), t.clear_lay = (e) => this.#k(e), t.finish_trans = () => !1, t.lay = (e) => this.#T(e), t.trans = (e) => this.#F(e), t.wt = (e) => C.wt(e), t.quake = (e) => this.#z(e), t.stop_quake = t.finish_trans, t.wq = t.wt, t.pause_tsy = (e) => C.pause_tsy(e), t.resume_tsy = (e) => C.resume_tsy(e), t.stop_tsy = (e) => C.stop_tsy(e), t.tsy = (e) => this.#B(e), t.wait_tsy = (e) => C.wait_tsy(e), t.add_filter = (e) => this.#V(e), t.clear_filter = (e) => this.#H(e), t.enable_filter = (e) => this.#U(e), t.ch = (e) => this.#G(e), t.clear_text = (e) => this.#$(e), t.current = (e) => this.#J(e), t.endlink = (e) => this.#ee(e), t.er = (e) => this.#te(e), t.graph = (e) => this.#ne(e), t.link = (e) => this.#re(e), t.r = (e) => this.#ie(e), t.ruby2 = (e) => this.#ae(e), t.span = (e) => this.#oe(e), t.tcy = (e) => this.#se(e), t.add_face = (e) => T.add_face(e), t.wv = (e) => T.wv(e), t.dump_lay = (e) => this.#ce(e), t.enable_event = (e) => this.#le(e), t.button = (e) => this.#ue(e), e.existsBreakline && (this.breakLine = (e) => {
			delete e.visible, e.id = "break", e.pic = "breakline", this.#m("grp｜" + I(e));
		}), e.existsBreakpage && (this.breakPage = (e) => {
			delete e.visible, e.id = "break", e.pic = "breakpage", this.#m("grp｜" + I(e));
		}), this.#i = d(String(e.oCfg.init.bg_color));
		let f = new s();
		f.beginFill(this.#i).lineStyle(0, this.#i).drawRect(0, 0, h.stageW, h.stageH).endFill(), this.#t.addChild(f.clone()), this.#n.addChild(f), this.#n.visible = !1, this.#t.name = "page:A", this.#n.name = "page:B", this.#e = n.stage, this.#e.addChild(this.#n), this.#e.addChild(this.#t), this.#e.addChild(this.#M), this.#e.addChild(this.#P), this.#e.name = "stage";
		let p = (e, t) => {
			this.#p(Number(t));
		};
		...
		m("", r.getVal("tmp:sn.button.fontFamily", E.fontFamily)), r.defValTrg("tmp:sn.button.fontFamily", m), r.defTmp("const.sn.last_page_text", () => this.currentTxtlayFore?.pageText ?? ""), r.defTmp("const.sn.last_page_plain_text", () => this.currentTxtlayFore?.pagePlainText ?? ""), h.isDbg && (j.init(n, o, a, l, e, this.#x), this.cvsResizeDesign = () => j.cvsResizeDesign(), o.addHook((e, t) => {
			this.#s[e]?.(e, t) && delete this.#s[e];
		}));
	}
	cvsResizeDesign() {}
	#s = {
		attach: (e) => (j.leaveMode(), !1),
		continue: (e) => (j.leaveMode(), !1),
		disconnect: (e) => (j.leaveMode(), !1),
		_enterDesign: (e) => {
			j.enterMode();
			for (let e of this.#S) {
				let t = this.#x[e].fore;
		...
		_replaceToken: (e, t) => (j.replaceToken(t), !1),
	...
	#u(e) {
		...
		let t = this.#x[this.#c];
		t && (j.allHide(), this.#l ? t.fore.showDesignCastChildren() : t.fore.showDesignCast());
	}
	...
	#f;
	setEvtMng(e) {
		this.#f = e, this.#r.setEvtMng(e), T.setEvtMng(e), C.init(e);
	}
	destroy() {
		for (let e of Object.values(this.#x)) e.destroy();
		this.#o.clear(), A.destroy(), D.destroy(), k.destroy(), O.destroy(), this.#r.destroy(), C.destroy(), O.msecChWait = 10;
	}
	#p(e) {
		for (let t of this.#S) {
			let { fore: n, back: r } = this.#x[t];
			n instanceof O && (n.chgBackAlpha(e), r.chgBackAlpha(e));
		}
	}
	...
	clickTxtLay() {
		return this.currentTxtlayFore ? this.#S.map((e) => this.#x[e].fore).some((e) => e instanceof O && e.click()) : !1;
	}
	#h(e) {
		let t = g("-", "_", "", "_"), n = e.fn ? e.fn.startsWith("userdata:/") ? e.fn : `${y + e.fn + t}.png` : `${y}snapshot${t}.png`, r = this.cfg.searchPath(n), i = f(e, "width", h.stageW), a = f(e, "height", h.stageH);
		return this.#g(e, r, i, a, `snapshot dt:${t}`);
	}
	#g = () => !1;
	#_({ layer: e }, t, n, r, i) {
		if (this.#r.hideAllFrame(), w.beginProc(i), !e) return this.sys.capturePage(t, n, r, () => {
			this.#r.restoreAllFrame(), w.endProc(i);
		}), !0;
		let a = this.#S.map((e) => {
			let { ctn: t } = this.#x[e].fore, n = [t, t.visible];
			return t.visible = !1, n;
		});
		for (let t of this.#I(e)) this.#x[t].fore.ctn.visible = !0;
	...
	#v(e, n, r, i, a) {
		...
		return Promise.allSettled(this.#I(d).map((e) => new Promise((t) => this.#x[e][u].snapshot(c, t)))).then(async () => {
			let e = t.create({
				width: c.width,
				height: c.height
			});
			c.render(this.#e, { renderTexture: e }), await this.sys.savePic(n, c.plugins.extract.base64(e)), e.destroy();
			for (let e of this.#I(d)) this.#x[e][u].snapshot_end();
			c.destroy(!0), w.endProc(a);
		}), !0;
	}
	#y(e) {
		let { fn: t } = e;
		...
		let n = m(e, "join", !0), r = w.procID + `loadplugin fn:${t}`;
		return n && w.beginProc(r), (async () => {
			let e = await fetch(t);
			if (!e.ok) throw Error("Network response was not ok.");
			p(await e.text()), n && w.endProc(r);
		})(), n;
	}
	#b(e) {
		...
		switch (this.#x[t] = new M(t, n, this.#t, this.#n, e, this.sys, this.val, r), this.#S.push(t), n) {
			case "txt":
				this.#C || (this.#Z = () => {}, this.#K = (e) => this.#q(e), this.#J = (e) => this.#Y(e), this.hTag.current({ layer: t }), this.goTxt = () => {
					this.#f.isSkipping ? O.msecChWait = 0 : this.setNormalChWait();
					for (let e of this.#S) {
						let t = this.#x[e].fore;
						t instanceof O && this.#m("gotxt｜", t, !1);
					}
		...
		return this.scrItr.recodeDesign(e), this.#D(), r.isWait;
	}
	#x = {};
	#S = [];
	#C = "";
	#w = "";
	#T(e) {
		let t = this.#Q(e), n = this.#x[t], r = n.back.ctn, i = n.fore.ctn;
	...
	#D() {
		for (let { fore: e, back: t } of Object.values(this.#x)) {
			let n = this.#t.getChildIndex(e.ctn);
			e.setDomZ(n), t.setDomZ(n);
		}
	}
	#O(e, t) {
		return this.#L(e, (n) => {
			let r = this.#x[this.#Q({ layer: n })];
			if (e.page === "both") {
				t(r.fore), t(r.back);
				return;
			}
	...
	#k(e) {
		let t = this.#O(e, (t) => t.clearLay(e));
		return C.stopTsyByLayer(t), !1;
	}
	...
	#P = new a(this.#N);
	#F(t) {
		let { layer: r } = t, i = /* @__PURE__ */ new Set(), a = this.#I(r).map((e) => (i.add(e), this.#x[e].fore)), o = () => {
			...
			Promise.allSettled(e).then(() => {
				this.#t.visible = !0, this.#n.visible = !1, this.#M.visible = !1, this.#P.visible = !1;
				for (let e of Object.values(this.#x)) e.fore.transUnbake(), e.back.transUnbake();
				this.#D(), w.notifyEndProc(S);
			});
		};
		if (this.#P.filters = [], this.#P.alpha = 1, f(t, "time", 0) === 0 || this.#f.isSkipping) return o(), !1;
		for (let e of Object.values(this.#x)) e.fore.transBake(), e.back.transBake();
		...
		d.render(this.#n, { renderTexture: this.#j });
		let p = b.renderGate(() => {
			for (let e of s) d.render(e, {
				renderTexture: this.#j,
				clear: !1
			});
		}, l.some((e) => e.containMovement)), m = () => d.render(this.#t, { renderTexture: this.#N });
		m();
		let h = b.renderGate(() => {
			this.#t.visible = !0, m(), this.#t.visible = !1;
		}, a.some((e) => e.containMovement)), g = () => {
			p(), this.#M.visible = !0, h(), this.#P.visible = !0;
		}, { glsl: _, rule: v } = t, y = () => {
			u.remove(g), o();
		};
		if (!_ && !v) return C.tween(S, t, this.#P, { alpha: 0 }, () => {}, y, () => {}), u.add(g), !1;
		let x = {
			rule: n.EMPTY,
			vague: f(t, "vague", .04),
			tick: 0
		};
		this.#P.filters = [new c(void 0, _ ?? e.#A, x)];
		let E = C.tween(S, t, x, { tick: 1 }, () => {}, y, () => {}, !v);
		return v ? new T(v, void 0, (e) => {
			x.rule = e.texture, e.destroy(), u.add(g), E.start();
		}, (e) => {
			e && this.main.resume();
		}).ret : (u.add(g), !1);
	}
	...
	setAllStyle2TxtLay(e) {
		for (let t of this.#S) {
			let n = this.#x[t].fore;
			n instanceof O && n.lay({ style: e });
		}
	}
	#z(e) {
		if (f(e, "time", NaN) === 0) return !1;
		let t = this.#I(e.layer).map((e) => this.#x[e].fore.ctn), { renderer: n, ticker: r } = this.appPixi;
		this.#N.resize(h.stageW, h.stageH);
		let i = () => {
			this.#t.visible = !0;
			for (let e of t) n.render(e, {
				renderTexture: this.#N,
				clear: !1
			});
			this.#t.visible = !1;
		};
		this.#P.visible = !0, this.#P.alpha = 1;
		let a = u(f(e, "hmax", 10)), o = u(f(e, "vmax", 10)), s = a === 0 ? () => {} : () => {
			this.#P.x = Math.round(Math.random() * a * 2) - a;
		}, c = o === 0 ? () => {} : () => {
			this.#P.y = Math.round(Math.random() * o * 2) - o;
		};
		return this.#P.filters = [], C.tween(S, e, this.#P, {
			x: 0,
			y: 0
		}, () => {
			s(), c();
		}, () => {
			r.remove(i), this.#t.visible = !0, this.#P.visible = !1, this.#P.x = 0, this.#P.y = 0, w.notifyEndProc(S);
		}, () => {}), r.add(i), !1;
	}
	#B(e) {
		...
		let c = C.cnvTweenArg(e, o), l = m(e, "arrive", !1), u = m(e, "backlay", !1), d = a.back.ctn;
		return C.tween(r ?? t, e, o, C.cnvTweenArg(e, o), () => {}, s, () => {
			if (l && Object.assign(o, c), u) for (let e of C.aLayerPrpNm) d[e] = o[e];
		}, !0, i), "filter" in e && (o.ctn.filters = [b.bldFilters(e)], o.aFltHArg = [e]), !1;
	}
	#V(e) {
		return this.#O(e, (t) => {
			let n = t.ctn;
			n.filters ??= [], n.filters = [...n.filters, b.bldFilters(e)], t.aFltHArg.push(e);
		}), !1;
	}
	#H(e) {
		return this.#O(e, (e) => {
			e.ctn.filters = null, e.aFltHArg = [];
		}), !1;
	}
	#U(e) {
		return this.#O(e, (t) => this.#W(t, e)), !1;
	}
	#W(e, t) {
		let n = e.ctn;
	...
	#G(e) {
		...
		let n = this.#K(e);
		delete e.text, this.setNormalChWait(), this.#f.isSkipping ? e.wait = 0 : "wait" in e && f(e, "wait", NaN), this.#m("add｜" + I(e), n);
	...
	#q(e) {
		let t = this.#Q(e, this.#C), n = this.#x[t].getPage(e);
		if (!(n instanceof O)) throw t + "はTxtLayerではありません";
		return n;
	}
	setNormalChWait() {
		O.msecChWait = this.scrItr.normalWait;
	}
	#J = (e) => {
		throw this.#Z(), 0;
	};
	#Y(e) {
		...
		let n = this.#x[t];
		if (!n || !(n.getPage(e) instanceof O)) throw `${t}はTxtLayerではありません`;
		this.#X = n, this.#a.pagebreak(), this.#C = t, this.val.setVal_Nochk("save", "const.sn.mesLayer", t);
		for (let e of this.#S) {
			let { fore: n, back: r } = this.#x[e];
			n instanceof O && (n.isCur = r.isCur = e === t);
		}
		return !1;
	}
	...
	#te(e) {
		return m(e, "rec_page_break", !0) && this.#a.pagebreak(), this.#X && (this.#X.fore.clearLay(e), this.#X.back.clearLay(e), C.stopTsyByLayer([this.#X.fore.layname])), !1;
	}
	#ne(e) {
		if (!e.pic) throw "[graph] picは必須です";
		return this.#m("grp｜" + I(e), this.#K(e)), !1;
	}
	#re(e) {
		if (!e.fn && !e.label && !e.url) throw "fn,label,url いずれかは必須です";
		return e.fn ??= this.scrItr.scriptFn, e.style ??= "background-color: rgba(255,0,0,0.5);", e.style_hover ??= "background-color: rgba(255,0,0,0.9);", e.style_clicked ??= e.style, this.#m("link｜" + I(e), this.#K(e)), !1;
	}
	#ie(e) {
		return this.#G({
			...e,
	...
	#ae(e) {
		...
		return e.text = "｜" + encodeURIComponent(t) + "《" + encodeURIComponent(n) + "》", delete e.t, delete e.r, this.#G(e);
	}
	#oe(e) {
		return this.#m("span｜" + I(e), this.#K(e)), !1;
	}
	#se(e) {
		if (!e.t) throw "[tcy] tは必須です";
		return this.#m("tcy｜" + I(e), this.#K(e)), !1;
	}
	#ce({ layer: e }) {
		console.group("🥟 [dump_lay]");
		for (let t of this.#I(e)) {
	...
	#le(e) {
		let t = this.#Q(e, this.#C), n = m(e, "enabled", !0);
		return this.#K(e).enabled = n, this.val.setVal_Nochk("save", "const.sn.layer." + t + ".enabled", n), !1;
	}
	#ue(e) {
		return M.argChk_page(e, "back"), e.fn ??= this.scrItr.scriptFn, this.#K(e).addButton(e), this.scrItr.recodeDesign(e), !1;
	}
	record() {
		let e = {};
		for (let t of this.#S) {
