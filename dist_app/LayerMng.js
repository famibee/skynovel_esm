...
var F = class c {
	...
	constructor(e, t, r, i, a, s, c, l, u) {
		...
		m("", i.getVal("tmp:sn.button.fontFamily", T.fontFamily)), i.defValTrg("tmp:sn.button.fontFamily", m), i.defTmp("const.sn.last_page_text", () => this.currentTxtlayFore?.pageText ?? ""), i.defTmp("const.sn.last_page_plain_text", () => this.currentTxtlayFore?.pagePlainText ?? ""), o.isDbg && (A.init(r, c, s, u, e, this.#x), this.cvsResizeDesign = () => A.cvsResizeDesign(), c.addHook((e, t) => {
	...
	#h(e) {
		let t = s("-", "_", "", "_"), n = e.fn ? e.fn.startsWith("userdata:/") ? e.fn : `${y + e.fn + t}.png` : `${y}snapshot${t}.png`, i = this.cfg.searchPath(n), a = r(e, "width", o.stageW), c = r(e, "height", o.stageH);
	...
	#N(e) {
		...
		if (!_ && !v) return S.tween(x, e, this.#M, { alpha: 0 }, () => {}, y, () => {}), l.add(h), !1;
		let b = {
			rule: u.EMPTY,
			vague: r(e, "vague", .04),
			tick: 0
		};
		this.#M.filters = [new g(void 0, _ ?? c.#O, b)];
		let T = S.tween(x, e, b, { tick: 1 }, () => {}, y, () => {}, !v);
		return v ? new w(v, void 0, (e) => {
			b.rule = e.texture, e.destroy(), l.add(h), T.start();
		}, (e) => {
			e && this.main.resume();
		}).ret : (l.add(h), !1);
	}
	...
	#L(e) {
		...
		return this.#M.filters = [], S.tween(x, e, this.#M, {
			...
			a.remove(s), this.#t.visible = !0, this.#M.visible = !1, this.#M.x = 0, this.#M.y = 0, C.notifyEndProc(x);
		}, () => {}), a.add(s), !1;
	}
	#R(e) {
		...
		let c = S.cnvTweenArg(e, o), l = a(e, "arrive", !1), u = a(e, "backlay", !1), d = i.back.ctn;
		return S.tween(r ?? t, e, o, S.cnvTweenArg(e, o), () => {}, s, () => {
			if (l && Object.assign(o, c), u) for (let e of S.aLayerPrpNm) d[e] = o[e];
		}), "filter" in e && (o.ctn.filters = [b.bldFilters(e)], o.aFltHArg = [e]), !1;
	}
	#z(e) {
		return this.#F(e, (t) => {
			let n = this.#x[this.#Z({ layer: t })];
