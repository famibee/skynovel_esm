...
export declare class SysApp extends SysBase {
    ...
    use4ViteElectron(src: string, path: string, ld: Loader, main: T_Main): boolean;
    ensureFile: (path: string) => Promise<void>;
    protected readFile(path: string, encoding: Parameters<typeof readFile>[1]): Promise<string>;
