...
}, []), Ce = "beforeRead", Ye = "read", Xe = "afterRead", je = "beforeMain", He = "main", Re = "afterMain", $e = "beforeWrite", Ae = "write", Fe = "afterWrite", Ve = [Ce, Ye, Xe, je, He, Re, $e, Ae, Fe];
function W(i) {
...
function ot(i, t, e) {
  ...
  var l = tt(i) ? j(i) : window, o = l.visualViewport, a = !ce() && e, h = (n.left + (a && o ? o.offsetLeft : 0)) / r, u = (n.top + (a && o ? o.offsetTop : 0)) / s, p = n.width / r, y = n.height / s;
  return {
    width: p,
    height: y,
    top: u,
...
function Ke(i) {
  ...
  if (!(!s || !l)) {
    var p = Ue(r.padding, e), y = Ht(s), d = a === "y" ? C : Y, m = a === "y" ? R : $, v = e.rects.reference[u] + e.rects.reference[a] - l[a] - e.rects.popper[u], g = l[a] - e.rects.reference[a], w = mt(s), c = w ? a === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, f = v / 2 - g / 2, b = p[d], E = c - y[u] - p[m], x = c / 2 - y[u] / 2 + f, T = ht(b, x, E), S = a;
...
function ii(i) {
  var t = i.state, e = i.instance, n = i.options, r = n.scroll, s = r === void 0 ? !0 : r, l = n.resize, o = l === void 0 ? !0 : l, a = j(t.elements.popper), h = [].concat(t.scrollParents.reference, t.scrollParents.popper);
...
function pe(i) {
  return ["html", "body", "#document"].indexOf(W(i)) >= 0 ? i.ownerDocument.body : H(i) && Ft(i) ? i : pe(kt(i));
}
function dt(i, t) {
  var e;
  t === void 0 && (t = []);
  var n = pe(i), r = n === ((e = i.ownerDocument) == null ? void 0 : e.body), s = j(n), l = r ? [s].concat(s.visualViewport || [], Ft(n) ? n : []) : n, o = t.concat(l);
  return r ? o : (
...
function Ti(i) {
  ...
  if (x) {
    if (s) {
      var P, A = b === "y" ? C : Y, I = b === "y" ? R : $, X = b === "y" ? "height" : "width", F = x[b], gt = F + g[A], z = F - g[I], yt = d ? -S[X] / 2 : 0, Mt = c === nt ? T[X] : S[X], at = c === nt ? -S[X] : -T[X], bt = t.elements.arrow, et = d && bt ? Ht(bt) : {
        width: 0,
        height: 0
...
function Si(i, t, e) {
  ...
  Ft(s)) && (o = _i(t)), H(t) ? (a = ot(t, !0), a.x += t.clientLeft, a.y += t.clientTop) : s && (a.x = At(s))), {
...
</div>`), this.#n = document.querySelector(".sn_hint"), this.#h = this.#n.querySelector("span"), this.#d = ji(this.#v, this.#n), this.#n.hidden = !0, n.stage.interactive = !0, this.#e.add(document.body, G, (c) => this.#l(c)), this.#e.add(document.body, "keyup", () => L.resetFired()), this.#e.add(r.cvs, "contextmenu", (c) => {
