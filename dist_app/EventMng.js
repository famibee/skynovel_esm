...
function rt(i, t, e) {
  ...
  var l = tt(i) ? j(i) : window, r = l.visualViewport, a = !ce() && e, u = (n.left + (a && r ? r.offsetLeft : 0)) / o, h = (n.top + (a && r ? r.offsetTop : 0)) / s, p = n.width / o, y = n.height / s;
  return {
    width: p,
    height: y,
    top: h,
...
function Ke(i) {
  ...
  if (!(!s || !l)) {
    var p = Ue(o.padding, e), y = Ht(s), d = a === "y" ? C : Y, m = a === "y" ? R : $, v = e.rects.reference[h] + e.rects.reference[a] - l[a] - e.rects.popper[h], g = l[a] - e.rects.reference[a], w = mt(s), c = w ? a === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, f = v / 2 - g / 2, b = p[d], E = c - y[h] - p[m], x = c / 2 - y[h] / 2 + f, T = ut(b, x, E), S = a;
...
function Qt(i) {
  ...
  if (u) {
    ...
    if (x === j(e) && (x = q(e), B(x).position !== "static" && r === "absolute" && (T = "scrollHeight", S = "scrollWidth")), x = x, o === C || (o === Y || o === $) && s === ft) {
      b = R;
...
function ii(i) {
  var t = i.state, e = i.instance, n = i.options, o = n.scroll, s = o === void 0 ? !0 : o, l = n.resize, r = l === void 0 ? !0 : l, a = j(t.elements.popper), u = [].concat(t.scrollParents.reference, t.scrollParents.popper);
...
function Ti(i) {
  ...
  if (x) {
    if (s) {
      var P, F = b === "y" ? C : Y, I = b === "y" ? R : $, X = b === "y" ? "height" : "width", V = x[b], gt = V + g[F], z = V - g[I], yt = d ? -S[X] / 2 : 0, Mt = c === nt ? T[X] : S[X], at = c === nt ? -S[X] : -T[X], bt = t.elements.arrow, et = d && bt ? Ht(bt) : {
        width: 0,
        height: 0
...
</div>`), this.#i = document.querySelector(".sn_hint"), this.#u = this.#i.querySelector("span"), this.#d = ji(this.#v, this.#i), this.#i.hidden = !0, n.stage.interactive = !0, this.#e.add(document.body, G, (c) => this.#r(c)), this.#e.add(document.body, "keyup", () => L.resetFired()), this.#e.add(o.cvs, "contextmenu", (c) => {
