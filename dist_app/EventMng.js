...
function ot(i, t, e) {
  ...
  var l = tt(i) ? j(i) : window, o = l.visualViewport, a = !ce() && e, u = (n.left + (a && o ? o.offsetLeft : 0)) / r, h = (n.top + (a && o ? o.offsetTop : 0)) / s, p = n.width / r, y = n.height / s;
  return {
    width: p,
    height: y,
    top: h,
...
function Ke(i) {
  ...
  if (!(!s || !l)) {
    var p = Ue(r.padding, e), y = Ht(s), d = a === "y" ? C : Y, m = a === "y" ? R : $, v = e.rects.reference[h] + e.rects.reference[a] - l[a] - e.rects.popper[h], g = l[a] - e.rects.reference[a], w = mt(s), c = w ? a === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, f = v / 2 - g / 2, b = p[d], E = c - y[h] - p[m], x = c / 2 - y[h] / 2 + f, T = ut(b, x, E), S = a;
...
</div>`), this.#i = document.querySelector(".sn_hint"), this.#u = this.#i.querySelector("span"), this.#d = ji(this.#v, this.#i), this.#i.hidden = !0, n.stage.interactive = !0, this.#e.add(document.body, G, (c) => this.#o(c)), this.#e.add(document.body, "keyup", () => L.resetFired()), this.#e.add(r.cvs, "contextmenu", (c) => {
