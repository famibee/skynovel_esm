import { e as F, k as v, z as lt, D as Q, o as T, d as j, R as A, G as M, y as G, O as X, B as tt, Q as ot, x as V, S as et, u as O, t as rt } from "./app2.js";
...
function mt(K, t, e, s, i, a = !0) {
  ...
  function b() {
    ...
    function y(f, p, _, C) {
      return Promise.resolve(p).then((R) => _ ? n.resolveUrl(R, _) : R).then(C || n.getAndEncode).then((R) => n.dataAsUrl(R, n.mimeType(p))).then((R) => f.replace(B(p), "$1" + R + "$3"));
      function B(R) {
    ...
    function S(f, p, _) {
      ...
      return Promise.resolve(f).then(m).then((B) => {
        ...
        for (const P of B) R = R.then((J) => y(J, P, p, _));
        return R;
      });
      function C() {
        return !r(f);
...
`, "%0A")}</foreignObject></svg>`, new Promise((m) => {
    ...
    r.width = e.$width, r.height = e.$height, r.getContext("2d").drawImage(d, 0, 0), K(lt.from(r));
  }).catch((d) => Q.myTrace(`goTxt() = ${d}`));
}
class c extends T {
  constructor(t, e, s) {
...
`)}`
  ...
  #y(t, e) {
    ...
    for (let u = s; u < g; ++u) {
      ...
      if (w.lnk) {
        ...
        const _ = new G();
        this.#P(_, p, y, r, k, S ?? {});
        const C = p.style ?? "", B = C + (p.style_hover ?? ""), R = C + (p.style_clicked ?? ""), P = p.r_style ?? "", J = P + (p.r_style_hover ?? ""), nt = P + (p.r_style_clicked ?? ""), Z = Array.from(f.getElementsByTagName("rt"));
  ...
  reNew() {
    ...
    return t.#t = this.#t, t.#e.style.cssText = this.#e.style.cssText, t.#r = this.#r, t.name = this.name, t.#_(), t.#B = this.#B, t.#v = this.#v, t.#E = this.#E, this.#l.reNew(t.#l), this.destroy(), t;
  }
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  #B = void 0;
  // 文字にかけるフィルター
  ...
  playback(t) {
    this.#t = t.infTL, this.position.set(this.#t.pad_left, this.#t.pad_top), this.#e.style.cssText = t.cssText, this.#r = t.left, this.#_(), this.#B = t.ch_filter, this.#v = t.fi_easing, this.#E = t.fo_easing, this.#l.playback(t.hyph);
  }
  get cssText() {
...
`), !1;
  ...
  #j(t, e) {
    ...
    if (t.b_pic) {
      ...
      (this.#i = new M()).beginFill(this.#_, s).lineStyle(void 0).drawRect(0, 0, this.#s.getWidth, this.#s.getHeight).endFill(),
      0
  ...
  chgBackAlpha(t) {
    ...
    this.#i instanceof M && (this.#i && (this.ctn.removeChild(this.#i), this.#i.destroy()), this.ctn.addChildAt(
      (this.#i = new M()).beginFill(this.#_, e).lineStyle(void 0).drawRect(0, 0, this.#s.getWidth, this.#s.getHeight).endFill(),
      0
    ), this.#i.name = "back(color)"), this.#i && (this.#i.visible = e > 0, this.#i.alpha = e);
  }
  #W(t) {
    "noffs" in t && (this.#H = t.noffs ?? "", this.#B = new RegExp(`[　${this.#H}]`)), "ffs" in t && (this.#v ??= "", this.#E = this.#v === "" ? () => "" : (e) => this.#B.test(e) ? "" : ` font-feature-settings: ${this.#v};`);
  }
  #v = "";
  #E = (t) => "";
  #H = "";
        ...
        switch (n) {
          ...
          case "add":
            {
              ...
              this.#R.push(`<span${k} style='${N} display: inline; ${$}'>`), delete o.style, this.#Q(o);
            }
            return;
          // breakではない
          case "add_close":
          ...
          case "grp":
            this.#w = !0;
            {
              ...
              this.#T = !1, o.delay = this.#M, o.r ??= "", o.style ??= "", o.r_style ??= "";
          ...
          case "link":
            this.#w = !0;
            {
              ...
              this.#R.push(`<span${$} style='${g} display: inline; ${o.style ?? ""}' ${k} data-arg='${h}'>`), delete o.style, this.#K(o);
            }
            return;
          // breakではない
          case "endlink":
...
`) {
    ...
    x.#k.isSkipping ? this.#M = 0 : t && this.#O && (this.#M += O(i));
    ...
    return {
      ...
      sty: `animation-delay: ${this.#M}ms;${this.#N.at(-1)?.o.style ?? ""}`,
      // TxtStage.goTxt()はこれ単位で文字出現させる
  ...
  clearText() {
    this.ctn.addChild(this.#s = this.#s.reNew()), this.#M = 0, this.#T = !0, this.#R = [], this.#G = "", this.#J = "", x.#a.pagebreak();
  }
  #G = "";
  #J = "";
  get pageText() {
