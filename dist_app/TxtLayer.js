import { e as F, k as S, z as ot, D as Q, o as P, d as T, R as A, G as M, y as q, O as X, B as tt, Q as ct, x as V, S as et, u as B, t as dt } from "./app2.js";
...
`, "%0A")}</foreignObject></svg>`, new Promise((u) => {
    ...
    d.width = e.$width, d.height = e.$height, d.getContext("2d").drawImage(o, 0, 0), K(ot.from(d));
  }).catch((o) => Q.myTrace(`goTxt() = ${String(o)}`));
}
class c extends P {
  constructor(t, e, s) {
    ...
    for (let g = s; g < y; ++g) {
      ...
      if (this.#g($), o.cmd === "grp") {
        ...
        this.#h.addChild(f), new W(m.pic, f, (p) => {
          this.#M(f, m, v, u, w, _ ?? {}), f.parent || f.removeChild(p);
        });
      }
      if (o.lnk) {
...
`), !1;
  ...
  static #u(t) {
    ...
    this.#t = {};
    for (let a = 0; a < s; ++a) this.#t[e[a]] = B(i[a]);
  ...
  #Y = (t, e) => {
    ...
    switch (i.length) {
      case 1:
        if (this.#w = !0, t === `
`) {
          this.#B ? (this.#B = !1, a = "<ruby>&emsp;<rt>&emsp;</rt></ruby><br/>") : a = "<br/>";
          break;
        }
        this.#B && (this.#B = !1, s === "" && (s = "&emsp;")), a = this.#X(t, s, this.#x);
        break;
      default:
        switch (n) {
          // ルビ揃え指定と同時シリーズ
          ...
          case "1ruby":
            this.#B = !1, this.#w = !0, a = this.#X(t, h, n);
            break;
          case "gotxt":
          ...
          case "add":
            {
              const r = JSON.parse(h), { style: b = "", wait: y = null } = r, { cl: w, sty: C } = this.#D(!0, y ? B(y) : null);
              this.#j.push(`<span${w} style='${C} display: inline; ${b}'>`), delete r.style, this.#Q(r);
            }
            return;
          // breakではない
          case "add_close":
          ...
          case "grp":
            this.#w = !0;
            {
              ...
              this.#B = !1, r.delay = this.#I, r.r ??= "", r.style ??= "", r.r_style ??= "";
              const { r: b, wait: y = null, r_style: w } = r, { cl: C, sty: x, lnk: N } = this.#D(!0, y ? B(y) : null);
          ...
          case "tcy":
            this.#B = !1, this.#w = !0;
            {
              ...
              const x = T.isSafari ? b.replaceAll(/[A-Za-z0-9]/g, (o) => String.fromCharCode(o.charCodeAt(0) + 65248)) : b, { cl: N, sty: g, lnk: $ } = this.#D(!0, y ? B(y) : null);
          ...
          case "link":
            this.#w = !0;
            {
              const r = JSON.parse(h);
              r[":link"] = " data-lnk='@'";
              const { cl: b, sty: y, curpos: w } = this.#D(!1, r.wait ? B(r.wait) : null);
              this.#j.push(`<span${b} style='${y} display: inline; ${r.style ?? ""}' ${w} data-arg='${h}'>`), delete r.style, this.#K(r);
            }
            return;
          // breakではない
          case "endlink":
...
`) {
    ...
    k.#k.isSkipping ? this.#I = 0 : t && this.#P && (this.#I += B(i));
    const a = `data-add='{"ch_in_style":"${this.#M}", "ch_out_style":"${this.#W}"}'`;
    return {
      cl: ` class='sn_ch sn_ch_yet sn_ch_in_${this.#M}'`,
  ...
  clearText() {
    this.ctn.removeChild(this.#s), this.ctn.addChild(this.#s = this.#s.reNew()), this.#I = 0, this.#B = !0, this.#j = [], this.#q = "", this.#J = "", k.#a.pagebreak();
  }
  #q = "";
  #J = "";
  get pageText() {
