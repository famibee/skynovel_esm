import { e as F, k as v, z as lt, D as Q, o as T, d as j, R as A, G as M, y as G, O as X, B as tt, Q as rt, x as V, S as et, u as O, t as ot } from "./app2.js";
...
function yt(K, t, e, s, i, a = !0) {
  ...
  function $() {
    ...
    function y(f, p, g, C) {
      return Promise.resolve(p).then((N) => g ? n.resolveUrl(N, g) : N).then(C || n.getAndEncode).then((N) => n.dataAsUrl(N, n.mimeType(p))).then((N) => f.replace(B(p), "$1" + N + "$3"));
      function B(N) {
    ...
    function R(f, p, g) {
      ...
      return Promise.resolve(f).then(m).then((B) => {
        let N = Promise.resolve(f);
        for (const P of B) N = N.then((J) => y(J, P, p, g));
        return N;
      });
      function C() {
        return !o(f);
...
`, "%0A")}</foreignObject></svg>`, new Promise((m) => {
    ...
    o.width = e.$width, o.height = e.$height, o.getContext("2d").drawImage(d, 0, 0), K(lt.from(o));
  }).catch((d) => Q.myTrace(`goTxt() = ${String(d)}`));
}
class c extends T {
  constructor(t, e, s) {
...
`)}`
  ...
  #_(t, e) {
    ...
    for (let u = s; u < _; ++u) {
      ...
      if (S.lnk) {
        ...
        const g = new G();
        this.#P(g, p, y, o, w, R ?? {});
        const C = p.style ?? "", B = C + (p.style_hover ?? ""), N = C + (p.style_clicked ?? ""), P = p.r_style ?? "", J = P + (p.r_style_hover ?? ""), nt = P + (p.r_style_clicked ?? ""), Z = Array.from(f.getElementsByTagName("rt"));
  ...
  reNew() {
    ...
    return t.#t = this.#t, t.#e.style.cssText = this.#e.style.cssText, t.#o = this.#o, t.name = this.name, t.#g(), t.#B = this.#B, t.#C = this.#C, t.#E = this.#E, this.#l.reNew(t.#l), this.destroy(), t;
  }
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  #B = void 0;
  // 文字にかけるフィルター
  ...
  playback(t) {
    this.#t = t.infTL, this.position.set(this.#t.pad_left, this.#t.pad_top), this.#e.style.cssText = t.cssText, this.#o = t.left, this.#g(), this.#B = t.ch_filter, this.#C = t.fi_easing, this.#E = t.fo_easing, this.#l.playback(t.hyph);
  }
  get cssText() {
...
`), !1;
  ...
  #j(t, e) {
    ...
    if (t.b_pic) {
      ...
      (this.#i = new M()).beginFill(this.#g, s).lineStyle(void 0).drawRect(0, 0, this.#s.getWidth, this.#s.getHeight).endFill(),
      0
  ...
  chgBackAlpha(t) {
    ...
    this.#i instanceof M && (this.#i && (this.ctn.removeChild(this.#i), this.#i.destroy()), this.ctn.addChildAt(
      (this.#i = new M()).beginFill(this.#g, e).lineStyle(void 0).drawRect(0, 0, this.#s.getWidth, this.#s.getHeight).endFill(),
      0
    ), this.#i.name = "back(color)"), this.#i && (this.#i.visible = e > 0, this.#i.alpha = e);
  }
  #W(t) {
    "noffs" in t && (this.#H = t.noffs ?? "", this.#B = new RegExp(`[　${this.#H}]`)), "ffs" in t && (this.#C ??= "", this.#E = this.#C === "" ? () => "" : (e) => this.#B.test(e) ? "" : ` font-feature-settings: ${this.#C};`);
  }
  #C = "";
  #E = (t) => "";
  #H = "";
      ...
      default:
        switch (n) {
          ...
          case "gotxt":
            ...
            ), this.#s.goTxt(this.#R, this.#M === 0), this.#w = !1, this.#M = 0) : this.isCur && this.#s.noticeCompTxt();
            return;
          // breakではない
          case "add":
            {
              const r = JSON.parse(h), { style: b = "", wait: _ = null } = r, { cl: w, sty: E } = this.#D(!0, _ ? O(_) : null);
              this.#R.push(`<span${w} style='${E} display: inline; ${b}'>`), delete r.style, this.#Q(r);
            }
            return;
          // breakではない
          case "add_close":
          ...
          case "grp":
            this.#w = !0;
            {
              ...
              this.#T = !1, r.delay = this.#M, r.r ??= "", r.style ??= "", r.r_style ??= "";
          ...
          case "link":
            this.#w = !0;
            {
              ...
              this.#R.push(`<span${b} style='${_} display: inline; ${r.style ?? ""}' ${w} data-arg='${h}'>`), delete r.style, this.#K(r);
            }
            return;
          // breakではない
          case "endlink":
...
`) {
    ...
    k.#k.isSkipping ? this.#M = 0 : t && this.#O && (this.#M += O(i));
    ...
    return {
      ...
      sty: `animation-delay: ${String(this.#M)}ms;${this.#N.at(-1)?.o.style ?? ""}`,
      // TxtStage.goTxt()はこれ単位で文字出現させる
  ...
  clearText() {
    this.ctn.addChild(this.#s = this.#s.reNew()), this.#M = 0, this.#T = !0, this.#R = [], this.#G = "", this.#J = "", k.#a.pagebreak();
  }
  #G = "";
  #J = "";
  get pageText() {
