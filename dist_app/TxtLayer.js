import { e as F, k as S, z as rt, D as Q, o as P, d as j, R as A, G as M, y as G, O as X, B as tt, Q as ot, x as V, S as et, u as B, t as ct } from "./app2.js";
...
`, "%0A")}</foreignObject></svg>`, new Promise((u) => {
    ...
    d.width = e.$width, d.height = e.$height, d.getContext("2d").drawImage(o, 0, 0), K(rt.from(d));
        ...
        switch (n) {
          ...
          case "add":
            {
              ...
              this.#T.push(`<span${w} style='${C} display: inline; ${b}'>`), delete r.style, this.#Q(r);
            }
            return;
          // breakではない
          case "add_close":
          ...
          case "tcy":
            this.#B = !1, this.#w = !0;
            {
              ...
              const x = j.isSafari ? b.replaceAll(/[A-Za-z0-9]/g, (o) => String.fromCharCode(o.charCodeAt(0) + 65248)) : b, { cl: N, sty: g, lnk: $ } = this.#D(!0, y ? B(y) : null);
          ...
          case "link":
            this.#w = !0;
            {
              ...
              this.#T.push(`<span${b} style='${y} display: inline; ${r.style ?? ""}' ${w} data-arg='${h}'>`), delete r.style, this.#K(r);
            }
            return;
          // breakではない
          case "endlink":
...
`) {
  ...
  clearText() {
    this.ctn.removeChild(this.#s), this.ctn.addChild(this.#s = this.#s.reNew()), this.#I = 0, this.#B = !0, this.#T = [], this.#G = "", this.#J = "", k.#a.pagebreak();
  }
  #G = "";
  #J = "";
  get pageText() {
